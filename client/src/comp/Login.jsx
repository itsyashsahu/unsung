...
export default function Login({login ,setLoginEmail,setLoginPassword,err,setErr}) {
    return (
        <div>
            <section className="text-gray-600 body-font">
            <div className="container px-5 lg:px-16 py-24 mx-auto flex flex-wrap items-center">
